...
public class ResultServiceTestIT {
    ...
    public void saveTest() throws Exception {
        ...
        ResultPerTheme perTheme0 = new ResultPerTheme(1L, "Theme#1", 5, true, 85.00d, 5);
        ResultPerTheme perTheme1 = new ResultPerTheme(2L, "Theme#2", 5, true, 75.00d, 4);
        ResultPerTheme perTheme2 = new ResultPerTheme(3L, "Theme#3", 5, false, 25.00d, 2);
        ResultPerTheme perTheme3 = new ResultPerTheme(4L, "Theme#4", 5, true, 50.00d, 3);

        Result result = new Result("D7C5E8BED7EDA2381E69126A40B3B22C", true, 58.75, 3,
                Arrays.asList(perTheme0, perTheme1, perTheme2, perTheme3));
        Long resultId = resultService.save(sessionData, result, false);
