...
import ua.edu.ratos.service.session.FirstBatchBuilder;
...
public class FirstBatchBuilderTestIT {
    ...
    public void build5Test()  {
        // We create a SessionData object with 5 different type of questions, not from within LMS
        ...
        // Now we create the first batch of one question out of 5 in total
        BatchOutDto batchOutDto = firstBatchBuilder.build(sessionData);
    ...
    public void build50Test()  {
        // We create a SessionData object with 25 questions (5 of each type), from within LMS
        Scheme scheme = schemeRepository.findForSessionById(1L);
        SessionData sessionData = sessionDataBuilder.build("38CB1A2F36F6FC1B217D335D87D57376", 1L, scheme, 1L);
        // Now we create the first batch of 5 question out of 25 in total
        BatchOutDto batchOutDto = firstBatchBuilder.build(sessionData);
