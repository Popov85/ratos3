...
public class SequenceMapperTest {
    ...
    public void init() {
        ...
        final QuestionMCQDomain q11 = createQuestionType1(1L, (byte) 1, "MCQ11", true);
        final QuestionMCQDomain q12 = createQuestionType1(2L, (byte) 1, "MCQ12", false);
        final QuestionMCQDomain q13 = createQuestionType1(3L, (byte) 1, "MCQ13", false);

        final QuestionMCQDomain q14 = createQuestionType1(4L, (byte) 2, "MCQ14", false);
        final QuestionMCQDomain q15 = createQuestionType1(5L, (byte) 2, "MCQ15", false);
        final QuestionMCQDomain q16 = createQuestionType1(6L, (byte) 2, "MCQ16", false);

        final QuestionMCQDomain q17 = createQuestionType1(7L, (byte) 3, "MCQ17", false);
        final QuestionMCQDomain q18 = createQuestionType1(8L, (byte) 3, "MCQ18", false);
        final QuestionMCQDomain q19 = createQuestionType1(9L, (byte) 3, "MCQ19", false);
        questionsType1 = new HashSet<>();
        questionsType1.addAll(Arrays.asList(q11, q12, q13, q14, q15, q16, q17, q18, q19));

        final QuestionFBSQDomain q21 = createQuestionType2(10L, (byte) 1, "FBSQ21", false);
        final QuestionFBSQDomain q22 = createQuestionType2(11L, (byte) 1, "FBSQ22", false);
        final QuestionFBSQDomain q23 = createQuestionType2(12L, (byte) 1, "FBSQ23", false);

        final QuestionFBSQDomain q24 = createQuestionType2(13L, (byte) 2, "FBSQ24", false);
        final QuestionFBSQDomain q25 = createQuestionType2(14L, (byte) 2, "FBSQ25", false);
        final QuestionFBSQDomain q26 = createQuestionType2(15L, (byte) 2, "FBSQ26", false);

        final QuestionFBSQDomain q27 = createQuestionType2(16L, (byte) 3, "FBSQ27", false);
        final QuestionFBSQDomain q28 = createQuestionType2(17L, (byte) 3, "FBSQ28", false);
        final QuestionFBSQDomain q29 = createQuestionType2(18L, (byte) 3, "FBSQ29", false);
        questionsType2 = new HashSet<>();
        questionsType2.addAll(Arrays.asList(q21, q22, q23, q24, q25, q26, q27, q28, q29));

        final QuestionSQDomain q51 = createQuestionType5(19L, (byte) 1, "SQ31", true);
        final QuestionSQDomain q52 = createQuestionType5(20L, (byte) 1, "SQ32", false);
        final QuestionSQDomain q53 = createQuestionType5(21L, (byte) 1, "SQ33", false);

        final QuestionSQDomain q54 = createQuestionType5(23L, (byte) 2, "SQ34", false);
        final QuestionSQDomain q55 = createQuestionType5(24L, (byte) 2, "SQ35", false);
        final QuestionSQDomain q56 = createQuestionType5(25L, (byte) 2, "SQ36", false);

        final QuestionSQDomain q57 = createQuestionType5(26L, (byte) 3, "SQ37", false);
        final QuestionSQDomain q58 = createQuestionType5(27L, (byte) 3, "SQ38", false);
        final QuestionSQDomain q59 = createQuestionType5(28L, (byte) 3, "SQ39", false);
    ...
    public void getMapTest() {
        ...
        final Map<Long, Map<Byte, List<QuestionDomain>>> map = sequenceMapper.getMap(1L, settings);
    ...
    public void getListTest() {
        ...
        final List<QuestionDomain> result = sequenceMapper.getList(1L, settings);
    ...
    private QuestionMCQDomain createQuestionType1(Long id, byte level, String question, boolean required) {
    ...
    private QuestionFBSQDomain createQuestionType2(Long id, byte level, String question, boolean required) {
    ...
    private QuestionSQDomain createQuestionType5(Long id, byte level, String question, boolean required) {
