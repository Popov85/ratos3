...
public class ThemeDomainViewDtoTransformerTest {
    ...
    public void init() {
        ...
        ThemeView t1 = buildThemeView(id1, "ThemeDomain #1", "MCQ", (short)10, (short)10,(short)10, (short)30);
        ThemeView t2 = buildThemeView(id2, "ThemeDomain #1", "FBSQ", (short)20, (short)15,(short)10, (short)45);
        ThemeView t3 = buildThemeView(id3, "ThemeDomain #1", "FBMQ", (short)20, (short)15,(short)10, (short)45);
        ThemeView t4 = buildThemeView(id4, "ThemeDomain #1", "MQ", (short)10, (short)10,(short)0, (short)20);
        ThemeView t5 = buildThemeView(id5, "ThemeDomain #1", "SQ", (short)10, (short)0,(short)0, (short)10);
        ...
        ThemeView t6 = buildThemeView(id6, "ThemeDomain #2", "MCQ", (short)10, (short)10,(short)10, (short)30);
        ThemeView t7 = buildThemeView(id7, "ThemeDomain #2", "FBSQ", (short)10, (short)15,(short)10, (short)35);
        ThemeView t8 = buildThemeView(id8, "ThemeDomain #2", "FBMQ", (short)10, (short)15,(short)10, (short)35);


        ThemeViewId id9 = buildId(3L, 1L);
        ThemeViewId id10 = buildId(3L, 5L);

        ThemeView t9 = buildThemeView(id9, "ThemeDomain #3", "MCQ", (short)10, (short)10,(short)10, (short)30);
        ThemeView t10 = buildThemeView(id10, "ThemeDomain #3", "SQ", (short)10, (short)10,(short)0, (short)20);
    ...
    public void toDtoTest() {
        ...
        final Set<ThemeOutDto> result = transformer.toDto(themeViews);
        result.forEach(r->{
            if (r.getThemeId()==1) {
