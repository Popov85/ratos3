...
public class QuestionMCQDomainTest {

    private QuestionMCQDomain question;

    private Set<AnswerMCQDomain> answers;
    ...
    public void evaluateOneCorrectRequiredTest() {
        ...
        Long[] userAnswers;
        ResponseMCQ response;

        // Empty response
        userAnswers = new Long[] {};
        response = new ResponseMCQ(1L, new HashSet(Arrays.asList(userAnswers)));
    ...
    private AnswerMCQDomain createAnswer(Long id, String title, short percentage, boolean isRequired) {
