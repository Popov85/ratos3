...
public class ResultBuilderServiceTest {
    ...
    public void buildTest() {
        ...
        final Number grade1 = resultPerTheme1.getMark();
        ...
        final Number grade2 = resultPerTheme2.getMark();
        ...
        final Number grade3 = resultPerTheme3.getMark();
        Assert.assertEquals(3, grade3);
        ...
        final Number grade4 = resultPerTheme4.getMark();
        Assert.assertEquals(2, grade4);
    }
    ...
    private void initBatchEvaluated(Long questionId, String question, Theme t, int score) {
        ...
        ResponseEvaluated re = new ResponseEvaluated(q, r, score);
    ...
    private BatchEvaluated getBatchEvaluated(Long questionId, ResponseEvaluated responseEvaluated) {
        ...
        return new BatchEvaluated(responsesEvaluated, null, 100);
    }
