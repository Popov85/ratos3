...
public class QuestionGenerator {
    ...
    protected QuestionMCQDomain createMCQ(Long questionId, String question) {
    ...
    protected QuestionFBSQDomain createFBSQ(Long questionId, String question) {
    ...
    protected SettingsFBDomain createSettingsFB() {
    ...
    protected QuestionFBMQDomain createFBMQ(Long questionId, String question, boolean partialResponse) {
    ...
    protected QuestionMQDomain createMQ(Long questionId, String question, boolean partialResponse) {
    ...
    protected QuestionSQDomain createSQ(Long questionId, String question) {
