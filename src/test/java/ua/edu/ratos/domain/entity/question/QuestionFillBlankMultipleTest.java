...
public class QuestionFillBlankMultipleTest {
    ...
    @Before
    public void init() {
        question = new QuestionFillBlankMultiple();
        question.setQuestionId(1L);

        AnswerFillBlankMultiple answer0 = createAnswer(1000l, PHRASE0, SAMPLES0);
        AnswerFillBlankMultiple answer1 = createAnswer(1001l, PHRASE1, SAMPLES1);
        AnswerFillBlankMultiple answer2 = createAnswer(1002l, PHRASE2, SAMPLES2);
    ...
    private AnswerFillBlankMultiple createAnswer(final Long answerId, final String phrase, final String[] acceptedPhrases) {
