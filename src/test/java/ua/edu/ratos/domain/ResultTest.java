...
public class ResultTest {
    ...
    private List<Result> result = Arrays.asList(
            new Result(17963L, "Clara", 0),
            new Result(17963L, "Clara", 35),
            new Result(17963L, "Clara", 60),
            new Result(17963L, "Clara", 78),
            new Result(17963L, "Clara", 90),
            new Result(17963L, "Clara", 120),
            new Result(17963L, "Clara", -1)
    );
