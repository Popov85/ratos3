...
insert into theme (name, course_id, created_by, belongs_to, access_id, created) values('Sample theme #1 (All MCQ)', 1, 1, 1, 1, '2020-07-18 11:45:15.999999999');
insert into theme (name, course_id, created_by, belongs_to, access_id, created) values('Sample theme #2 (All FBSQ)', 1, 1, 1, 1, '2020-07-18 11:45:15.999999999');
insert into theme (name, course_id, created_by, belongs_to, access_id, created) values('Sample theme #3 (All FBMQ)', 1, 1, 1, 1, '2020-07-18 11:45:15.999999999');
insert into theme (name, course_id, created_by, belongs_to, access_id, created) values('Sample theme #4 (All MQ)', 1, 1, 1, 1, '2020-07-18 11:45:15.999999999');
insert into theme (name, course_id, created_by, belongs_to, access_id, created) values('Sample theme #5 (All SQ)', 1, 1, 1, 1, '2020-07-18 11:45:15.999999999');
...
insert into type_level(scheme_theme_id, type_id, level_1, level_2, level_3) values(5, 5, 10, 0, 0);
