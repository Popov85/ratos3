...
insert into answer_sq(element, element_order, question_id) values('clean', 0, 1);
insert into answer_sq(element, element_order, question_id) values('validate', 1, 1);
insert into answer_sq(element, element_order, question_id) values('compile', 2, 1);
insert into answer_sq(element, element_order, question_id) values('test', 3, 1);
...
insert into answer_sq_resource(answer_id, resource_id) values(1, 11);
insert into answer_sq_resource(answer_id, resource_id) values(2, 12);
insert into answer_sq_resource(answer_id, resource_id) values(3, 13);
insert into answer_sq_resource(answer_id, resource_id) values(4, 14);

insert into answer_sq(element, element_order, question_id) values('phase #0 (Q2)', 0, 2);
insert into answer_sq(element, element_order, question_id) values('phase #1 (Q2)', 1, 2);
insert into answer_sq(element, element_order, question_id) values('phase #2 (Q2)', 2, 2);
insert into answer_sq(element, element_order, question_id) values('phase #3 (Q2)', 3, 2);
...
insert into answer_sq_resource(answer_id, resource_id) values(5, 15);
insert into answer_sq_resource(answer_id, resource_id) values(6, 16);
insert into answer_sq_resource(answer_id, resource_id) values(7, 17);
insert into answer_sq_resource(answer_id, resource_id) values(8, 18);

insert into answer_sq(element, element_order, question_id) values('phase #0 (Q3)', 0, 3);
insert into answer_sq(element, element_order, question_id) values('phase #1 (Q3)', 1, 3);
insert into answer_sq(element, element_order, question_id) values('phase #2 (Q3)', 2, 3);
insert into answer_sq(element, element_order, question_id) values('phase #3 (Q3)', 3, 3);
...
insert into answer_sq_resource(answer_id, resource_id) values(9, 19);
insert into answer_sq_resource(answer_id, resource_id) values(10, 20);
insert into answer_sq_resource(answer_id, resource_id) values(11, 21);
insert into answer_sq_resource(answer_id, resource_id) values(12, 22);

insert into answer_sq(element, element_order, question_id) values('phase #0 (Q4)', 0, 4);
insert into answer_sq(element, element_order, question_id) values('phase #1 (Q4)', 1, 4);
insert into answer_sq(element, element_order, question_id) values('phase #2 (Q4)', 2, 4);
insert into answer_sq(element, element_order, question_id) values('phase #3 (Q4)', 3, 4);
...
insert into answer_sq_resource(answer_id, resource_id) values(13, 23);
insert into answer_sq_resource(answer_id, resource_id) values(14, 24);
insert into answer_sq_resource(answer_id, resource_id) values(15, 25);
insert into answer_sq_resource(answer_id, resource_id) values(16, 26);

insert into answer_sq(element, element_order, question_id) values('phase #0 (Q5)', 0, 5);
insert into answer_sq(element, element_order, question_id) values('phase #1 (Q5)', 1, 5);
insert into answer_sq(element, element_order, question_id) values('phase #2 (Q5)', 2, 5);
insert into answer_sq(element, element_order, question_id) values('phase #3 (Q5)', 3, 5);
...
insert into answer_sq_resource(answer_id, resource_id) values(17, 27);
insert into answer_sq_resource(answer_id, resource_id) values(18, 28);
insert into answer_sq_resource(answer_id, resource_id) values(19, 29);
insert into answer_sq_resource(answer_id, resource_id) values(20, 30);