...
insert into accepted_phrase(phrase, staff_id, last_used) values ('lock', 1, CURRENT_TIMESTAMP);

insert into accepted_phrase(phrase, staff_id, last_used) values ('find', 1, CURRENT_TIMESTAMP);
insert into accepted_phrase(phrase, staff_id, last_used) values ('find()', 1, CURRENT_TIMESTAMP);

insert into accepted_phrase(phrase, staff_id, last_used) values ('refresh', 1, CURRENT_TIMESTAMP);
insert into accepted_phrase(phrase, staff_id, last_used) values ('refresh()', 1, CURRENT_TIMESTAMP);
insert into accepted_phrase(phrase, staff_id, last_used) values ('refresh();', 1, CURRENT_TIMESTAMP);
