...
insert into phrase(phrase, staff_id, last_used) values ('accepted phrase #4', 1, CURRENT_TIMESTAMP);
insert into phrase(phrase, staff_id, last_used) values ('accepted phrase #5', 1, CURRENT_TIMESTAMP);
insert into phrase(phrase, staff_id, last_used) values ('accepted phrase #6', 1, CURRENT_TIMESTAMP);
