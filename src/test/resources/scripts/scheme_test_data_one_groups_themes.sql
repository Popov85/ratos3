...
insert into u_groups(name, is_enabled, created_by, belongs_to, created)
values ('Group #2', 1, 1, 1, '2020-07-18 11:45:15.999999999');
insert into u_groups(name, is_enabled, created_by, belongs_to, created)
values ('Group #3', 1, 1, 1, '2020-07-18 11:45:15.999999999');
insert into u_groups(name, is_enabled, created_by, belongs_to, created)
values ('Group #4', 1, 1, 1, '2020-07-18 11:45:15.999999999');
insert into u_groups(name, is_enabled, created_by, belongs_to, created)
values ('Group #5', 1, 1, 1, '2020-07-18 11:45:15.999999999');
