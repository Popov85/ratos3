...
insert into user (name, surname, password, email, is_active) values('Andrey','Popov','{bcrypt}$2a$10$e.MY/qnalhvaoqI5QczLSuahfGbmthqd0QJh2NJ/38nB7LOZCW7d.','andrey.popov@gmail.com', 1);
insert into user_role(user_id, role_id) VALUES (1, 8);
insert into staff (user_id, dep_id, pos_id) values(1, 1, 1);

insert into user (name, surname, password, email, is_active) values('Student','Student','{bcrypt}$2a$10$e.MY/qnalhvaoqI5QczLSuahfGbmthqd0QJh2NJ/38nB7LOZCW7d.','student@gmail.com', 1);
...
insert into course (name, created, created_by, dep_id) values('Test edX course #1', CURRENT_TIMESTAMP, 1, 1);

insert into lti1p0_credentials(lti_consumer_key, lti_client_secret) values('edx_consumer_key', 'edx_client_secret');
