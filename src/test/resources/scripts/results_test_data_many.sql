...
insert into user (name, surname, password, email, is_active) values('Den','Abramov','{bcrypt}$2a$10$e.MY/qnalhvaoqI5QczLSuahfGbmthqd0QJh2NJ/38nB7LOZCW7d.','den.abramov@example.com', 1);
insert into user_role(user_id, role_id) VALUES (7, 2);
insert into student (stud_id, class_id, fac_id, org_id, entrance_year) values(7, 1, 1, 1, 2020);
...
insert into result(scheme_id, user_id, dep_id, percent, grade, is_passed, session_ended, session_lasted, is_timeouted, is_cancelled, lms_id)
...
insert into result(scheme_id, user_id, dep_id, percent, grade, is_passed, is_points_granted, session_ended, session_lasted, is_timeouted, is_cancelled, lms_id)
