...
insert into question (title, level, type_id, theme_id, lang_id) values ('MCQ choice question #6', 1, 1, 2, 1);
insert into question (title, level, type_id, theme_id, lang_id) values ('MCQ choice question #7', 1, 1, 2, 1);
insert into question (title, level, type_id, theme_id, lang_id) values ('MCQ choice question #8', 1, 1, 2, 1);
insert into question (title, level, type_id, theme_id, lang_id) values ('MCQ choice question #9', 1, 1, 2, 1);
