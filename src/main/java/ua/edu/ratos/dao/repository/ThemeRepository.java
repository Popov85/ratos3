...
public interface ThemeRepository extends JpaRepository<Theme, Long> {
    ...
    @Query(value = "SELECT t FROM Theme t join fetch t.course join fetch t.access a join fetch t.staff s join fetch s.user join fetch s.position where t.themeId =?1")
    Optional<Theme> findForEditById(Long themeId);
