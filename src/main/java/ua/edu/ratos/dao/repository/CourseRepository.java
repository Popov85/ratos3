...
public interface CourseRepository extends JpaRepository<Course, Long> {
    ...
    Page<Course> findAllByStaffIdAndNameContains(Long staffId, String letters, Pageable pageable);
    ...
    Page<Course> findAllByDepartmentIdAndNameContains(Long depId, String letters, Pageable pageable);
