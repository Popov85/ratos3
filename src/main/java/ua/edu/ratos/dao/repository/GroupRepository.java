...
public interface GroupRepository extends JpaRepository<Group, Long> {
    ...
    @Query(value = "SELECT g FROM Group g join fetch g.staff s where s.staffId =?1", countQuery = "SELECT count(g) FROM Group g join g.staff s where s.staffId =?1")
    Page<Group> findAllByStaffId(Long staffId, Pageable pageable);

    @Query(value = "SELECT g FROM Group g join fetch g.staff s join s.department d where d.depId =?1", countQuery = "SELECT count(g) FROM Group g join g.staff s join s.department d where d.depId =?1")
    ...
    @Query(value = "SELECT g FROM Group g join fetch g.staff s join s.department d where d.depId =?1 and g.name like ?2%",
    ...
    @Query(value = "SELECT g FROM Group g join g.staff s join s.department d where s.staffId =?1 and g.enabled = true")
    Slice<Group> findAllForDropDownByStaffId(Long staffId, Pageable pageable);

    @Query(value = "SELECT g FROM Group g join g.staff s join s.department d where d.depId =?1 and g.enabled = true")
    Slice<Group> findAllForDropDownByDepartmentId(Long depId, Pageable pageable);

    //---------------------------------------------------Dropdown search------------------------------------------------

    @Query(value = "SELECT g FROM Group g join g.staff s join s.department d where s.staffId =?1 and g.enabled = true and g.name like ?2%")
    ...
    @Query(value = "SELECT g FROM Group g join g.staff s join s.department d where d.depId =?1 and g.enabled = true and g.name like ?2%")
