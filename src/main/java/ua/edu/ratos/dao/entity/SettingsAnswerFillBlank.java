...
public class SettingsAnswerFillBlank {
    ...
    public SettingsFB toDomain() {
        return new SettingsFB()
                .setSettingsId(this.settingsId)
                .setName(this.name)
                .setWordsLimit(this.getWordsLimit())
                .setSymbolsLimit(this.getSymbolsLimit())
                .setNumeric(this.isNumeric())
                .setLang(this.getLang().getAbbreviation())
                .setTypoAllowed(this.isTypoAllowed)
