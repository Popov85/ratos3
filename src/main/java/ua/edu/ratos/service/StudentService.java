...
public class StudentService {
    ...
    private static final String STUDENT_NOT_FOUND = "The requested Student not found, studId = ";
    ...
    @Autowired
    public void setStudDtoTransformer(StudDtoTransformer studDtoTransformer) {
        this.studDtoTransformer = studDtoTransformer;
    }
