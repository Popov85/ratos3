...
public class ResultOfStudentController {
    ...
    private ResultOfStudentsService resultOfStudentsService;

    @Autowired
    public void setResultOfStudentsService(ResultOfStudentsService resultOfStudentsService) {
        this.resultOfStudentsService = resultOfStudentsService;
    }
