...
public class SessionController {
        ...
        @GetMapping("/next")
        @ResponseBody
        public String provideNextQuestion(HttpSession session, HttpServletRequest request) {
                ...
                try {
                        ...
                        iSession.processStudentAnswer(new ArrayList<>());
                        question = sessionService.provideNextQuestion(iSession);
        ...
        private ISession getSession(HttpSession session, HttpServletRequest request) throws LostSessionException {
                ...
                try {
                        ...
                        if (iSession==null) {
                                iSession = sessionService.restore(Long.valueOf(getCookie(request)));
                        }
                } catch (Exception e) {
